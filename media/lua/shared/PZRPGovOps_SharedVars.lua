...
PZRP_GovOpsVars = {}
PZRP_GovOpsVars.modDataString = "PZRPGovernmentData"
PZRP_GovOpsVars.programName = "Kentucky OS"


-- UI STUFF

PZRP_GovOpsVars.dataEntryWidth = 330
PZRP_GovOpsVars.dataEntryHeigth = 500
